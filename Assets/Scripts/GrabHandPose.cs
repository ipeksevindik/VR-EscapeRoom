...
{
    public float poseTransitionDuration = 0.4f;
    ...
    private Quaternion[] startingFinerRotation;
    private Quaternion[] finalFinerRotation;
    ...
    public void SetupPose(BaseInteractionEventArgs args)
    {
        ...
        if(args.interactorObject is XRDirectInteractor)
        {
            ...
            StartCoroutine(SetHandDataRoutine(handData, finalHandPosition, finalHandRotation, finalFinerRotation, startingHandPosition, startingHandRotation, startingFinerRotation ));
    ...
    public void UnsetPose(BaseInteractionEventArgs args)
    {
        if (args.interactorObject is XRDirectInteractor)
        {
            ...
            StartCoroutine(SetHandDataRoutine(handData, startingHandPosition, startingHandRotation, startingFinerRotation, finalHandPosition, finalHandRotation, finalFinerRotation));
    ...
    public void SetHandDataValues(HandData h1, HandData h2)
    {
        ...
        startingFinerRotation = new Quaternion[h1.fingerBones.Length];
        finalFinerRotation = new Quaternion[h2.fingerBones.Length];

        for (int i = 0; i < h1.fingerBones.Length; i++)
        {
            startingFinerRotation[i] = h1.fingerBones[i].localRotation;
            finalFinerRotation[i] = h2.fingerBones[i].localRotation;
        }
